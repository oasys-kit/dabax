...
filename = "CrossSec_NIST.dat"
f = open(filename, 'w')

header = ""
header += '#F %s' % filename
header += '\n#C  This file has been created using CrosssSec_NIST.py on ' + time.strftime("%Y-%m-%d %H:%M:%S", local_time)
header += '\n#C  Note: for Mass Energy Absorption coefficient and cross section see file CrossSec_NIST_MassEnergyAttenuation.dat'
...
header += '\n#UD 3:TotalCrossSection[barn/atom] (Mass Attenuation)'
