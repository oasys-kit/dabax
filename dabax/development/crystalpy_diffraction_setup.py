...
# import xraylib
from tmp.dabax_util import Crystal_GetCrystal
from tmp.dabax_util import Crystal_dSpacing
from tmp.dabax_util import Bragg_angle
from tmp.dabax_util import Crystal_F_H_StructureFactor
...
class DiffractionSetupDabax(DiffractionSetupAbstract):
    ...
    def __init__(self,
        ...
        try:
            self._crystal = Crystal_GetCrystal(self.crystalName(), dabax_repository=dabax_repository)
        except:
    ...
    def angleBragg(self, energy):
        ...
        try:
            angle_bragg = Bragg_angle(self._crystal,
                                              energy_in_kev,
                                              self.millerH(),
                                              self.millerK(),
                                              self.millerL(),)
    ...
    def F0(self, energy):
        ...
        energy_in_kev = energy / 1000.0
        try:
            F_0 = Crystal_F_H_StructureFactor(self._crystal,
                                                      energy_in_kev,
                                                      0, 0, 0,
    ...
    def dSpacing(self):
        ...
        try:
            d_spacing = Crystal_dSpacing(self._crystal,
                                                 self.millerH(),
                                                 self.millerK(),
                                                 self.millerL())
        except:
